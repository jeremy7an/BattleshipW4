...
static class FAQ
{
	...
	public static void DrawFAQ ()
	{
		...
		SwinGame.DrawText ("Press M to mute, Press N to unmute", Color.White, GameResources.GameFont ("Courier"), 0, 540);
		SwinGame.DrawText ("Click anywhere to go back to the menu", Color.Yellow, GameResources.GameFont ("Courier"), 0, 560);

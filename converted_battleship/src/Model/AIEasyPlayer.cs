...
//removed a few files to make the AI easy such as searching and targeting enum - by Jeremy Toh
class AIEasyPlayer : AIPlayer
{
	...
	// Main changes
	// I removed the codes so AI wont target around the tile that has been hit 
	// making it hitting randomly on the time. - by Jeremy Toh
